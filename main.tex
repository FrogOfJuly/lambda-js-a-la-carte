...
%
%
Despite its success in formalizing CompCert and CakeML, its extensible inductive type representation is not easily compatible with plain Rocq inductive types due to their parametrization within modules. This effectively locks development to this particular dialect of Rocq, which can be undesirable.
