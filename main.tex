...
such as React~\cite{React}, Solid~\cite{***}, and others.
...
to mechanize the semantics of major programming languages (cf.~CompCert~\cite{***} and CakeML\cite{***}),
...
It will also be possible to reuse proofs to prove further properties
of the language's dialects (e.g., TypeScript),
as well as various JavaScript frameworks (e.g., React, ***, ***).

We are particularly interested in mechanizing
mutability, exceptions, reactivity, and asynchrony of JavaScript---%
in light of the \emph{Signals} proposal~\cite{***},
