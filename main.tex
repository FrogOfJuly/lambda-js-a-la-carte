...
Resulting feature functors allow per-functor proofs without relaying on a particular structure of overarching type.
...
The apporach is illustrated with an example \ref{fig:alacart_example} that roughtly outlines extension of untyped lambda calculus with with booleans and if-then-else constructions. 
