...
\todo[inline]{Why Rocq\cite{the_coq_development_team_2024_14542673},  as a foundation, why can't use directly, imporovements, what I want to do}

We follow closely ideas from Coq à la Carte\cite{forster2020coq} to enable modularity. Direct use of the meta tooling is prohibitively difficult due to outdated Metarocq, but the overall structure of reasoning holds surprisingly well even without them. 
